...
const candidates: Candidate[] = [
  ...
  candidate('load', 'static', .80,
    phrase(/\b(?:holds?|supports?|mounted|bracket|shelf|constant load|hook|holder|clamp|mount|håller|monterad|fäste|konsol|konstant last|krok|hållare|klämma)\b/i)),
