...
const definitions: FacetDefinition[] = [
  ...
  { id: 'environment-uv', category: 'operating-environment', label: 'Exposure', value: 'direct sun / UV', confidence: .95, impact: 'active-requirement', patterns: [/\b(?:direct sun|sunlight|sun exposure|uv(?: exposure)?|direkt sol|solljus|solexponering|uv-ljus)\b/iu] },
  ...
  { id: 'environment-food', category: 'operating-environment', label: 'Exposure', value: 'food contact', confidence: .96, impact: 'needs-specialist-review', patterns: [/\b(?:food contact|touches food|food-safe|kitchen utensil|livsmedelskontakt|kontakt med mat|livsmedelssäker|köksredskap)\b/iu] },
  ...
  { id: 'fit-seal', category: 'interface', label: 'Fit', value: 'sealing interface', confidence: .95, impact: 'active-requirement', patterns: [/\b(?:sealing surface|o-ring|gasket seat|tätningsyta|o-ring|packningsläge)\b/iu] },
  ...
  { id: 'surface-mating', category: 'critical-surface', label: 'Critical surface', value: 'mating surface', confidence: .94, impact: 'active-requirement', patterns: [/\b(?:mating surface|contact surface|bearing seat|mounting face|anliggningsyta|kontaktyta|lagerläge|monteringsyta)\b/iu] },
  ...
  { id: 'lifetime-temporary', category: 'intended-lifetime', label: 'Lifetime', value: 'temporary / prototype', confidence: .9, impact: 'future-requirement', patterns: [/\b(?:temporary|one[- ]off prototype|short[- ]term|proof of concept|tillfällig|engångsprototyp|kortvarig|koncepttest)\b/iu] },
