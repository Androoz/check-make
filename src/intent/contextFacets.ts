...
const definitions: FacetDefinition[] = [
  ...
  { id: 'failure-safety', category: 'failure-consequence', label: 'Failure consequence', value: 'safety-critical', confidence: .98, impact: 'needs-specialist-review', patterns: [/\b(?:safety[- ]critical|load[- ]critical|failure (?:could|can|may) (?:injure|hurt)|supports? a person|overhead load|personsäkerhet|säkerhetskritisk|lastkritisk|fel (?:kan|riskerar att) skada|bär en person|last över huvudet)\b/iu] },
